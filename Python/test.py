...
cap = cv2.VideoCapture('señorita-shawn-mendes-camila-cabello-bachata-dance-choreography-solo-latin-lady-dance.mp4')
...
Recorder = cv2.VideoWriter('distanceAndSpeed2.mp4', fourcc, 30.0, output_dim)
